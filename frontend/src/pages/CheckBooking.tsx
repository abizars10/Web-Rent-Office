      ...
      <section id="Check-Booking" className="relative flex flex-col w-[930px] shrink-0 gap-[30px] mx-auto mb-[100px] z-20">
        <form onSubmit={handleSubmit} className="flex items-end rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[16px] bg-white">
          <div className="flex flex-col w-full gap-2">
            ...
            {formErrors.find((error) => error.path.includes("booking_trx_id")) && <p className="text-red-500">Booking Trx Id is reqiured</p>}
          </div>
          <div className="flex flex-col w-full gap-2">
            ...
            {formErrors.find((error) => error.path.includes("phone_number")) && <p className="text-red-500">Phone number is reqiured</p>}
          </div>
